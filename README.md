...
- タイミング別ページから、全エリアの対象マニュアルをまとめた印刷用チェックリストを出力できます。
- 管理者はログイン後にマニュアル一覧、作成、編集、印刷、バックアップ出力を使えます。ログイン状態は24時間保持します。
- マニュアル編集画面では、各手順の下への差し込み、上下移動、1手順ずつの削除、登録済み写真の削除ができます。
